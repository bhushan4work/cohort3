...
frontend for this assignment is inside public folder
*/
...
//returning html also from backend itself to avoid cors error
app.get("/", (req, res) => {
...
function auth(req, res, next) {
    ...
    const token = req.headers.authorization; //on postman headers do : authorization : input
